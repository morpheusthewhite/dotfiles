# Generated by Powerlevel10k configuration wizard on 2022-07-18 at 10:38 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=113
  ...
  #####################################[ vcs: git status ]######################################
  # Branch icon. Set this parameter to '\UE0A0 ' for the popular Powerline branch icon. Alternative: '\uF126 '
